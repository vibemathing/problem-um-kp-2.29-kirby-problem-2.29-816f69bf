...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-2.29-kirby-problem-2.29-816f69bf-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-2.29"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-2.29-kirby-problem-2.29-816f69bf-v1",
      "problem_contract_sha256": "f85d608d64a8ab9d568c775db219530141e96165aa3476e5af64df7cd60b4b7c",
      "problem_id": "problem:um-kp-2.29-kirby-problem-2.29-816f69bf",
      "route_id": "route:um-kp-2.29-kirby-problem-2.29-816f69bf-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-2.29-kirby-problem-2.29-816f69bf-source-fidelity-01",
      "graph_id": "graph:um-kp-2.29-kirby-problem-2.29-816f69bf-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-2.29-kirby-problem-2.29-816f69bf-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-2.29-kirby-problem-2.29-816f69bf-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Determine the Artin groups that can be embedded into a map- ping class group."
          },
          "statement_sha256": "c79b12414cbc1c1333cdb427d4ee98801fa2f4f48daec3982ca61bdb4f11abe5"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-2.29-kirby-problem-2.29-816f69bf-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-2.29-kirby-problem-2.29-816f69bf-root",
      "route_id": "route:um-kp-2.29-kirby-problem-2.29-816f69bf-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-2.29-86b08b303324",
        "url": "https://www.unsolvedmath.com/problems/KP-2.29"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
